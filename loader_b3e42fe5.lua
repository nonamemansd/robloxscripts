--[[ 
    GENERATED LOADER BY PYTHON SCRIPT
    Target: {target_script}
]]

local CONFIG = {
    Title = "Photios HUB KEYSYSTEM",
    KeyURL = "https://raw.githubusercontent.com/nonamemansd/robloxscripts/refs/heads/main/main.txt",
    ScriptURL = "https://raw.githubusercontent.com/Solvexxxx/Scripts/refs/heads/main/SolvexGUI99nights.lua",
    Linkvertise = "https://direct-link.net/2628650/w11KL8MWdKXe"
}
...
CheckBtn.MouseButton1Click:Connect(function()
    ...
    local success, actualKey = pcall(function()
