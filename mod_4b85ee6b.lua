...
if CoreGui:FindFirstChild("KeySystem_vFreLbzUH") then CoreGui["KeySystem_vFreLbzUH"]:Destroy() end
local sg = Instance.new("ScreenGui", CoreGui)
sg.Name = "KeySystem_vFreLbzUH"
local iNfHEKk = Instance.new("Frame", sg)
iNfHEKk.Size = UDim2.new(0, 300, 0, 180)
iNfHEKk.Position = UDim2.new(0.5, -150, 0.5, -90)
iNfHEKk.BackgroundColor3 = CONFIG.BG
Instance.new("UICorner", iNfHEKk).CornerRadius = UDim.new(0, 8)
local t = Instance.new("TextLabel", iNfHEKk)
t.Size = UDim2.new(1, 0, 0, 40)
t.Text = CONFIG.Title
t.TextColor3 = Color3.new(1,1,1)
t.BackgroundTransparency = 1
local k = Instance.new("TextBox", iNfHEKk)
k.Size = UDim2.new(0.8, 0, 0, 35)
k.Position = UDim2.new(0.1, 0, 0.35, 0)
k.PlaceholderText = "Enter Key..."
local btn = Instance.new("TextButton", iNfHEKk)
